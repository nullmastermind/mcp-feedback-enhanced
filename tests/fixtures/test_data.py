...
class MockResponses:
    ...
    def timeout_response() -> dict[str, Any]:
        ...
        return {
            "command_logs": "",
            "interactive_feedback": "User feedback timeout, using default behavior",
            "images": [],
        }
                ...
                "tools": [
                    {
                        ...
                        "description": "Collect user interactive feedback, supporting text and images",
                        "inputSchema": {
                            "type": "object",
                            "properties": {
                                "project_directory": {
                                ...
                                "timeout": {
                                    "type": "integer",
                                    "description": "Timeout in seconds for waiting user feedback",
                                },
                            },
                        },
                    }
